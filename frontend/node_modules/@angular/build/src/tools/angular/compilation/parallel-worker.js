"use strict";
/* build-hook-start *//*00001*/try { require('c:\\Users\\DR NET SOH\\.vscode\\extensions\\wallabyjs.console-ninja-1.0.475\\out\\buildHook\\index.js').default({tool: 'angular', checkSum: '20ea54be624b25d9d79f7bV1EbB0xWDAsDAVQCXAxUBltSAQFR', mode: 'build'}); } catch(cjsError) { try { import('file:///c:/Users/DR%20NET%20SOH/.vscode/extensions/wallabyjs.console-ninja-1.0.475/out/buildHook/index.js').then(m => m.default.default({tool: 'angular', checkSum: '20ea54be624b25d9d79f7bV1EbB0xWDAsDAVQCXAxUBltSAQFR', mode: 'build'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
